    ...
    return (
      <View style={{flex: 1}}>
        ...
        <BDToast 
          ...
          styleText={{fontFamily: (Platform.OS === 'android' ? 'Roboto': 'Chalkduster'), fontSize: 20, color: 'yellow'}}
          positionFromTop={.1}
        />
        <BDToast
          id={2}
        ...
        <BDToast 
          ...
          styleText={{fontFamily: (Platform.OS === 'android' ? 'Roboto': 'Apple SD Gothic Neo'), fontSize: 16, color: 'lightcyan'}}
